...
class DependencyInjectionTest extends TestCase {
    public function testResolvesCallbackParametersFromContainer() {
        ...
        $this->assertEquals([$t1, $t2], DependencyInjection::resolveParametrs($callback));
    }
    ...
    public function testResolvesCallbackParametersFromRouteParameters() {
        ...
        $this->assertEquals(
            ...
            DependencyInjection::resolveParametrs($callback, $routeParams)
        );
    }
